...
#g++ -std=c++11 -shared coref_kernels.cc -o coref_kernels.so -I $TF_INC -I "${TF_INC}/external/nsync/public" -fPIC
#g++ -std=c++11 -shared srl_kernels.cc -o srl_kernels.so -I $TF_INC -I "${TF_INC}/external/nsync/public" -fPIC

echo $TF_INC
echo $TF_LIB

g++ -std=c++11 -shared coref_kernels.cc -o coref_kernels.so -I$TF_INC -I$TF_INC/external/nsync/public -L$TF_LIB -ltensorflow_framework -fPIC -O2 
...
#g++ -std=c++11 -shared coref_kernels.cc -o coref_kernels.so -I$TF_INC -I$TF_INC/external/nsync/public -L$TF_LIB -ltensorflow_framework -fPIC -O2 -D_GLIBCXX_USE_CXX11_ABI=0
